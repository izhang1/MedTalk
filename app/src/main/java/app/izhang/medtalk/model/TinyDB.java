...
public class TinyDB {
    ...
    public ArrayList<MedInfo> getListObject(String key, Class<?> mClass){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<MedInfo> objects =  new ArrayList<>();

        for(String jObjString : objStrings){
            Object value  = gson.fromJson(jObjString,  mClass);
            objects.add((MedInfo) value);
        }
    ...
    public void putListObject(String key, ArrayList<MedInfo> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
